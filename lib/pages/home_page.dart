...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final tools = <_ToolItem>[
      const _ToolItem('ACG RSS', Icons.rss_feed_rounded, Color(0xFF2563EB),
          builder: _buildAcgRssPage),
      const _ToolItem('新番', Icons.movie_filter_outlined, Color(0xFFF59E0B),
          builder: _buildNewAnimePage),
      const _ToolItem('NAS', Icons.storage_rounded, Color(0xFFEF4444),
          builder: _buildNasPage),
      const _ToolItem('音乐列表', Icons.library_music_rounded, Color(0xFF7C3AED),
          builder: _buildMusicListPage),
      const _ToolItem('AI 小助手', Icons.auto_awesome_rounded, Color(0xFF8B5CF6)),
      const _ToolItem(
          '拍照扫描', Icons.document_scanner_rounded, Color(0xFF0EA5E9)),
      ...
      const _ToolItem(
          '记账角落', Icons.account_balance_wallet_outlined, Color(0xFF14B8A6)),
      ...
      const _ToolItem(
          '文件快传', Icons.swap_horizontal_circle_outlined, Color(0xFF4F46E5)),
...
Widget _buildMusicListPage(BuildContext context) => const MusicListPage();
